...
load(here('Rdata/global.Rdata'))
load(here('Rdata/regional.Rdata'))
load(here('Rdata/hbc.Rdata'))
load(here('Rdata/rr.Rdata'))
load(here('Rdata/rrg.Rdata'))
load(here('Rdata/vr.Rdata'))
load(here('Rdata/cty.Rdata'))
load(here('Rdata/att.Rdata'))
load(here('Rdata/bpos.Rdata'))
...
cfr <- est[year == yr,
           {
             tmp = divXY(mort, inc, mort.sd ^ 2, inc.sd ^ 2)
...
save(rf, file = here('Rdata/rf.Rdata'))


#' aggregate rf
#'
load(here('Rdata/rf.Rdata'))
...
save(rf.global, file = here('Rdata/rf.global.Rdata'))
save(rf.regional, file = here('Rdata/rf.regional.Rdata'))
